      ...
      >
        {links.map((item, index) => (
          <>
            <li
              key={index}
              className="md:ml-8 text-md md:my-0 my-7 w-full items-center flex justify-center space-y-4 md:space-y-0 md:w-auto "
            >
              <a href={item.path} className=" duration-200">
                {item.name}
              </a>
            </li>
          </>
        ...
        <Link
          ...
          className=" w-full items-center flex justify-center space-y-4 md:space-y-0 md:w-auto"
          target='_blank'
        >
