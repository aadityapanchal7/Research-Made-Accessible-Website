    ...
    <section className="flex justify-center mt-20 bg-gray-50 md:h-64">
      <div className="w-full max-w-[1340px] flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 flex items-center justify-center">
          <h2 className="text-3xl font-bold text-balance text-center tracking-tight text-blue-950 sm:text-5xl">
        ...
        {/* Video Container */}
        <div className="md:w-1/2 flex justify-center items-center mt-20">
          <video className=" md:mr-20 md:mx-0 mx-10 shadow-md bg-blue-300 p-5" controls >
